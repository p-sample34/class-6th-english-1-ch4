async function loadQuestions() {
  try {
    ...
    const res = await fetch('https://class-6th-english-1-ch4.onrender.com/questions');
    if (!res.ok) {
...
async function submitAnswers() {
  ...
  try {
    ...
    const res = await fetch('https://class-6th-english-1-ch4.onrender.com/submit-answers', {
      method: 'POST',
